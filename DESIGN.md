...
- **Primary 700** (`#1D4ED8`): メインブランドカラー。ヘッダー、リンク、セカンダリボタン、フォーカスリング。白背景コントラスト比 約6.7:1（WCAG AA適合）
- **Primary 800** (`#1E40AF`): ホバー・プレス時
- **Primary 500** (`#3B82F6`): アイコン、イラスト、グラデーション用の明るいブルー（小さな文字には使わない）
...
| 種別 | テキスト色 | 背景色 |
|------|----------|--------|
| 通学 | `#1D4ED8` (Blue 700) | `#EFF6FF` (Blue 50) |
